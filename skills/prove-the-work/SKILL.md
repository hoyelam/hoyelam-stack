...
3. Distinguish required checks from optional evidence using the request, repository instructions, CI, and change risk. Route applicable iOS and macOS behavior through `$verify-apple-apps` and applicable Electron behavior through `$verify-electron-apps`.
