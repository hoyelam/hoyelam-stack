...
9. `REPORT`: status, revision or artifact identifier, changed paths, evidence actually collected, deviations, blockers, and suggested follow-ups.
10. `STANDING`: the complete current standing-order list.
