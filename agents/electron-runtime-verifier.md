...
3. Run focused tests, the full relevant suite, static checks, and a production-representative packaged build.
...
10. Return the evidence contract from `$verify-electron-apps` and every unverified boundary.
