...
4. Run the selected focused tests, broader suite, and production-representative application build according to the changed boundary and risk.
...
10. Return the selected evidence contract from `$verify-apple-apps` and every material unverified boundary.
