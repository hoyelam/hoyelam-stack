...
3. Identify the smallest harness that exercises the real user surface safely and repeatably.
4. Prefer existing tooling and stable interaction handles.
5. Define independent evidence for visible behavior and side effects.
